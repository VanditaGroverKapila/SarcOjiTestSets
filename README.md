...
* Special mention: Due to unavailability of dataset on the Riloff dataset was eventually sourced from https://github.com/MirunaPislar/Sarcasm-Detection/tree/master/res/datasets/riloff (1368 records in Train set, 588 records in Test set) 
### Dataset Statistics
